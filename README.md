...
Responsive ve modern web standartlarına uygun tasarlanmıştır.
...
Proje şu anda aktif olarak yayındadır. Uygulamayı denemek ve farklı kullanıcı rollerini test etmek için aşağıdaki bağlantıyı kullanabilirsiniz:

🔗 **Canlı Demo Bağlantısı:** [https://mertkadakal.github.io/LockNest/](https://mertkadakal.github.io/LockNest/)

### 🔑 Test Hesapları:
* **Admin Paneli:** `admin@beykoz.com` (Şifre rastgele girilebilir)
* **Manager Paneli:** `manager@locknest.com` (Şifre: `manager123`)
...
<p align="center">
  <img src="./images/admin_dashboard.png" width="800" alt="Admin Dashboard">
</p>
<p align="center">
  <img src="./images/admin_reports.png" width="800" alt="Admin Raporlar">
</p>
